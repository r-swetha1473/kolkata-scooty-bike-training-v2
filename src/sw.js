 ...
 */
const VERSION = 'v7-no-dynamic-media-cache';
...
self.addEventListener('fetch', (event) => {
  ...
  // Never cache API responses or uploaded/legacy media — admin updates must show immediately.
  if (url.pathname.startsWith('/api/') || url.pathname.startsWith('/media/') || url.pathname.startsWith('/uploads/')) {
