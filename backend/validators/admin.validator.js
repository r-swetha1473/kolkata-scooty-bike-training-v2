...
/**
 * Validation rules for marking trainer leave
 */
const validateTrainerLeave = [
  param('id')
    .isUUID()
    .withMessage('Trainer ID must be a valid UUID'),
  ...
  body('leave_date')
    ...
    .withMessage('leave_date must be a valid ISO date (YYYY-MM-DD)'),
...
/**
 * Validation rules for restoring trainer from leave
 */
const validateTrainerLeaveRestore = [
  param('id')
    .isUUID()
    .withMessage('Trainer ID must be a valid UUID'),
