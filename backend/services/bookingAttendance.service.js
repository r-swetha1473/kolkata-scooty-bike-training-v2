...
const { syncEnrollmentFromBookings } = require('./customerProgress.service');
...
async function updateBookingAttendance(adminId, bookingId, attendanceStatus) {
  ...
  if (updated.user_id && updated.course_id) {
    await syncEnrollmentFromBookings(null, updated.user_id, updated.course_id, updated.branch_id);
  }
